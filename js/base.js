	...
	$.extend(toolkit, {
		...
		showLoading: function (el) {
			...
			if (mask.length > 0) {
				...
				mask = $('<div class="loading-mask"><i></i></div>');
			}
			if (el) {
    ...
    $.extend(this, {
        ...
        _fixTableHeader:function () {
            ...
            if($.fn.stickyTableHeaders){
                $(".fix-table-header").stickyTableHeaders().on({
                    'clonedHeader.stickyTableHeaders':function () {
                        $(document).trigger('clonedHeader.tb',this);
                    },
                    'enabledStickiness.stickyTableHeaders':function () {
                        $(document).trigger('enabledStickiness.tb',this);
                    },
                    'disabledStickiness.stickyTableHeaders':function (argument) {
                        $(document).trigger('disabledStickiness.tb',this);
                    }
